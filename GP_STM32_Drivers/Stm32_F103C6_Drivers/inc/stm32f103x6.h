...
//GPIO
//A,B fully included in LQFB48 Package
#define GPIOA_BASE 							  0x40010800UL
#define GPIOB_BASE 0x40010C00UL

//C,D Partial included in LQFB48 Package
#define GPIOC_BASE                            0x40011000UL
#define GPIOD_BASE                            0x40011400UL

//E is not included in LQFB48 Package
...
#define GPIOA                            ((GPIO_TypeDef*)GPIOA_BASE) //INstead of (GPIO_TypeDef *GPIOA = (GPIO_TypeDef *)GPIO_BASE; )
...
#define NVIC_IRQ0_WWDG_Enable()            (NVIC_ISER0 |= 1<<0)

#define NVIC_IRQ0_WWDG_Disable()           (NVIC_ICER0 |= 1<<0)
...
//I2C
#define NVIC_IQR31_I2C1_EV_Enable()			(NVIC_ISER0 |= (1<<I2C1_EV_IRQ)) // NVIC_ISER0
#define NVIC_IQR32_I2C1_ER_Enable()			(NVIC_ISER1 |= (1<<(I2C1_ER_IRQ - 32))) // 32 - 32 = 0
#define NVIC_IQR33_I2C2_EV_Enable()			(NVIC_ISER1 |= (1<<(I2C2_EV_IRQ - 32))) // 33 - 32 = 1
#define NVIC_IQR34_I2C2_ER_Enable()			(NVIC_ISER1 |= (1<<(I2C2_ER_IRQ - 32))) // 34 - 32 = 2

#define NVIC_IQR31_I2C1_EV_Disable()			(NVIC_ICER0 |= (1<<I2C1_EV_IRQ)) // NVIC_ICER0
...
//Timer
#define NVIC_IQR28_TIM2_Enable()			    (NVIC_ISER0 |= (1<<TIM2_IRQ)) // NVIC_ISER0
#define NVIC_IQR29_TIM3_Enable()			    (NVIC_ISER0 |= (1<<TIM3_IRQ)) // NVIC_ISER0
#define NVIC_IQR30_TIM4_Enable()			    (NVIC_ISER0 |= (1<<TIM4_IRQ)) // NVIC_ISER0

#define NVIC_IQR28_TIM2_Disable()		     	(NVIC_ICER0 |= (1<<TIM2_IRQ)) // NVIC_ICER0
